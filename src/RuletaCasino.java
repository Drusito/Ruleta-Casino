...
public class RuletaCasino {
    ...
    static boolean[][] isRed = {//Los elementos "true" son rojos, los "false son negros, en la ruleta.
    ...
    public static void imprimirRuleta() {
        ...
        stop(CYAN + "\nPulse ENTER para continuar..." + RESET);
    }
     ...
     * @return opcion valor de salida (input del usuario)
     */
    public static int menuApuestas() {
        ...
        if(dineroDisponible > 0) {
            ...
            do {
                if(opcion != 13) { //Las apuestas de la opcion 13 concretamente se guardan en un array no en una variable.
                    apuesta = leerFloat("Introduce tu apuesta:");
                }
     ...
     * @param opcionElegida valor de entrada int
     */
    public static void girarRuleta(int opcionElegida) {
        if(restriccionGiros == 0) {
            ...
            switch (opcionElegida) {
                ...
                case 11:
                    //ROJO
                    if (isRedBool(numGanador, numerosRojos)) {
                        premio = apuesta * 2;
                        dineroDisponible += premio;
                        mensajeGanador(premio);
                    } else mensajePerdedor();
     ...
     * @param message valor de entrada String
     */
     ...
     * @param n valor de entrada int
     * @return valor de salida boolean (si es par o no)
     */
     ...
     * @param numGanador valor de entrada int
     * @param numerosRojos valor de entrada int[]
     * @return valor de salida boolean (Indica si es rojo)
     */
    public static boolean isRedBool(int numGanador, int[] numerosRojos) {
     ...
     * @param _text valor de entrada String (Texto a imprimir.)
     * @param min valor de entrada mínimo
     * @param max valor de entrada máximo
     * @return value valor de salida (input del usuario)
     */
     ...
     * @param _text valor de entrada String (Texto a imprimir)
     * @return value valor de salida float (lectura del input)
     */
    ...
    public static void mensajeBienvenida() {
        System.out.println(GREEN + "******* BIENVENIDO  A LA  RULETA **********\n" + RESET);
    }
     ...
     * @param tercio Valor de entrada int(Tercio elegido por el usuario)
     * @param numGanador valor de entrada int (numero generado por la ruleta)
     * @return boolean valor de salida boolean(Dice si el numero está dentro del tercio o no)
     */
     ...
     * @param opcion valor de entrada int
     */
     ...
     * @param premio valor de entrada float
     */
    ...
    public static void menuPrincipal () {
        int opcion=0;
        opcion = leerInt(YELLOW+"Selecciona una opción:\n\t"+GREEN+"1- "+YELLOW+"Empezar Partida\n\t"+GREEN+"2-"+YELLOW+" Instrucciones\n\t"+GREEN+"3-"+YELLOW+" Salir\n", 1, 3);
    ...
    /**
     * Primera pagina instrucciones
     */
    public static void menuInstruccionesPagUno () {
        int opcion = 0;
        System.out.println("\t\t\t\t*** Instrucciones de la ruleta ***\n");
        System.out.println(GREEN+"1."+YELLOW+" [1-12] | [13-24] | [25-32]");
        System.out.println(RESET+"\tSi el usuario apuesta en una de estas tres opciones y el número ganador aparece\n" +
        ...
        opcion = leerInt(CYAN+"\t\t\t\t1 <-- Volver Menú || Siguiente --> 2\n", 1, 2);
        switch (opcion) {
            case 1:
                menuPrincipal();
                break;
    ...
    /**
     * Seguna página instrucciones
     */
    public static void menuInstruccionesPagDos () {
        int opcion = 0;
        System.out.println(GREEN+"2."+YELLOW+" [1/3] | [2/3] | [3/3]");
        System.out.println(RESET+"\tEl usuario puede elegir que fila quiere apostar, [1/3] corresponde a la fila de arriba.\n" +
        ...
        opcion = leerInt(CYAN+"\t\t\t\t1 <-- Atras || Siguiente --> 2\n", 1, 2);
    ...
    /**
     * Tercera página de intrucciones
     */
    public static void menuInstruccionesPagTres () {
        int opcion = 0;
        System.out.println(GREEN+"3."+YELLOW+" [1-18] | [19-36]");
        System.out.println(RESET+"\tEl usuario tendrá dos opciones para apostar, si el número ganador corresponde a la opción gandora,\n" +
    ...
    /**
     * Cuarta página de instrucciones
     */
    public static void menuInstruccionesPagCuatro () {
        int opcion = 0;
        System.out.println(GREEN+"4. "+YELLOW+"[PAR] | [IMPAR]");
        System.out.println(RESET+"\tEl usuario tendrá dos opciones para apostar, si el número ganador es igual a la opción\n" +
    ...
    /**
     * Quinta página de instrucciones
     */
    public static void menuInstruccionesPagCinco () {
        int opcion = 0;
        System.out.println(GREEN+"5. "+YELLOW+"["+RED+"ROJO"+YELLOW+"] | ["+BLACK+"NEGRO"+YELLOW+"]");
        System.out.println(RESET+"\tEl usuario dispone de dos opciones para apostar, si el número ganador corresponde con el color\n" +
    ...
    /**
     * Sexta página de instrucciones
     */
    public static void menuInstruccionesPagSeis () {
        int opcion = 0;
        System.out.println(GREEN+"6."+YELLOW+" Apostar uno o más números");
        System.out.println(RESET+"\tEl usaurio podrá apostar a uno o varios números de la ruleta y si el número ganador coincide\n" +
        ...
        opcion = leerInt(CYAN+"\t\t\t\t1 <-- Atras || Salir --> 2\n", 1, 2);
